...
rownames(stoch_growthArray) <- paste(hunt_seq)
colnames(stoch_growthArray) <- paste(harvest_seq)

rownames(disp_pop) <- paste(hunt_seq)
colnames(disp_pop) <- paste(harvest_seq)
